const selectElement = document.getElementById("select-type") as HTMLInputElement;
const listSection = document.getElementById("list-wrapper") as HTMLDivElement;
...
async function fetchData(endPoint:string):Promise<object>{
    try {
